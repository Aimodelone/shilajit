  ...
  const testimonials = [
    {
      ...
      text: `"Since I started using Purefit, my energy levels have skyrocketed. I'm more alert and focused, and it's transformed my daily productivity. Highly recommended!"`,
    ...
    },
    {
      ...
      quote: '/assets/img/icon/quote.svg',
      text: `"As a fitness enthusiast, strawberry protine is a game-changer. It boosts my workout endurance and recovery, so I can push harder and feel great the next day."`,
      rating: '/assets/img/icon/tst_rating.png',
    ...
    },
    {
      ...
      quote: '/assets/img/icon/quote.svg',
      text: `"I'm a busy professional, and stress used to take a toll on my health. Purefit has helped me manage stress, and I feel calmer and more in control. It's a lifeline in my demanding life."`,
      rating: '/assets/img/icon/tst_rating.png',
